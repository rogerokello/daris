...
//print_r($report_ids_to_be_edited);
  echo $this->Form->create('Alevelreportdetail', array('action' => 'search'));
...
<table>
    ...
    <tr>
	<td><?php echo $report['Alevelreportdetail']['reportname'];?></td>
	<td>
	    <?php echo $report['Alevelreportdetail']['reportterm'];?>
	
	</td>
	<td>
	<?php 
		if ( $report['Alevelreportdetail']['reportclass'] != null ) {
		
		    echo "Senior ".$report['Alevelreportdetail']['reportclass'];
		    
		}else{
		
		    echo $report['Alevelreportdetail']['reportclass'];
		
		}
	    ?>
	</td>
	<td><?php echo $report['Alevelreportdetail']['reportyear'];?></td>
	<td>
		  <span id="drop-nav2">
		  ...
		  <ul>
		      ...
		      <li><a href="#">View </a>
				...
				<?php echo $this->Form->postLink(
					'Individudal ',
					array('action' => 'viewReports', $report['Alevelreportdetail']['id'],0)
					    );?>	  
			    </li>
			    <li>
				<?php echo $this->Form->postLink(
					'Marksheet ',
					array('action' => 'viewReports', $report['Alevelreportdetail']['id'],1)
					    );?>
			    </li>
			</ul>
		      ...
		      <li><a href="#">Download </a>
				...
				<?php echo $this->Form->postLink(
					'Single Report',
					array('action' => 'downloadReports', $report['Alevelreportdetail']['id'],4)
					    );?>	  
			    </li>
				...
				<?php echo $this->Form->postLink(
					'Report(s)',
					array('action' => 'downloadReports', $report['Alevelreportdetail']['id'],3),
				...
				<?php echo $this->Form->postLink(
					'Marksheets(Combined)',
					array('action' => 'downloadReports', $report['Alevelreportdetail']['id'],1),
				...
				<?php echo $this->Form->postLink(
					'Result(s) summary ',
					array('action' => 'downloadReports', $report['Alevelreportdetail']['id'],2),
		      ...
		      <li><a href="#">Update  </a>
				...
				echo $this->Form->postLink(
					'Marks ',
					array('action' => 'updateReports', $report['Alevelreportdetail']['id'],1),
				...
				echo $this->Form->postLink(
					'Missing Students',
					array('action' => 'updateReports', $report['Alevelreportdetail']['id'], 2),
					array('confirm' => 'This action will update all the individudal records parmanently, Are you sure you want to continue?')
					    ); 
					    ?>
			    </li>
		       ...
		       <li><a href="#">Comment on </a>
				...
				echo $this->Form->postLink(
					...
					array('action' => 'comment', $report['Alevelreportdetail']['id'],1),
				...
				echo $this->Form->postLink(
					...
					array('action' => 'comment', $report['Alevelreportdetail']['id'],2),
					array('confirm' => 'This action will take a while downloading a comment file, Are you sure you want to continue?')
					    ); 
					    ?>
			    </li>
				...
				echo $this->Form->postLink(
					'Warden Section ',
					array('action' => 'comment', $report['Alevelreportdetail']['id'],3),
					array('confirm' => 'This action will take a while downloading a comment file, Are you sure you want to continue?')
					    ); 
					    ?>
			    </li>
				...
				<?php echo $this->Form->postLink(
					'Matron Section ',
					array('action' => 'comment', $report['Alevelreportdetail']['id'],4),
					array('confirm' => 'This action will take a while downloading a comment file, Are you sure you want to continue?')
					    );?>
			    </li>
			</ul>
		      ...
		      <?php
				echo $this->Html->link(
				    'Edit',
				     array('action' => 'edit', $report['Alevelreportdetail']['id'], 1)
				     );
					    ?>
					    <!--
		        <ul>
				...
				echo $this->Html->link(
				    'Exams Considered',
				     array('action' => 'edit', $report['Alevelreportdetail']['id'], 2)
				     ); 
					    */?>
			    </li>
			</ul>-->
		      ...
		      <li><a href="#">Delete</a>
				...
				echo $this->Form->postLink(
					'All report Details ',
					array('action' => 'delete', $report['Alevelreportdetail']['id']),
				...
				echo $this->Form->postLink(
					'Single report ',
					array('action' => 'delete', $report['Alevelreportdetail']['id'], 1 )
					//array('confirm' => 'This action will delete this report parmanently, Are you sure you want to continue?')
					    );
					    ?>
			    </li>
