...
<h1 class="sectiondefinition1">New Staff Record</h1>
 <?php 
 ...
 ?>
    ...
    echo $this->Form->input('Staffdetail.picturepath', array('between' => '<br />', 'type' => 'file', 'label' => 'Attach your picture(A jpeg of not more than 200 Kilobytes)', 'accept' =>'image/*'));
    ?>
    </td>
    </tr></table>
    <?php
