...
<?php
  echo $this->Form->create('Staffdetail', array('action' => 'search'));
  if (!isset($searchQuery)) {
    $searchQuery = '';
  }
  echo $this->Form->input('searchQuery', array('label' => 'Search for Staff','value' => h($searchQuery)));
  echo $this->Form->end(__('Search'));
?>
<table>
    <tr>
	<th>Picture</th>
	<th><?php echo $this->Paginator->sort('name','Names');?></th>
    ...
    <tr class='studentpic'>
	<?php     
		$picuturepresent = $student['Staffdetail']['studenthaspic'];
		 if($picuturepresent == "YES"){
		    $picvariable = "background: url(/daris/img/staffpics/".$student['Staffdetail']['picturenumber'].'.jpg'.");background-size: 100%;background-repeat: no-repeat;	background-position: center top;";
		    ...
		    $picvariable = "background: url(/daris/img/staffpics/person.png);background-size: 100%;background-repeat: no-repeat;	background-position: center top;";
		    
		    //"background: url(/daris/img/staffpics/person.png);background-size: 60%;background-repeat: no-repeat;	background-position: center top;";
	...
	<td><?php echo $student['Staffdetail']['name'];?></td>
	<td><?php echo $student['Staffdetail']['phonenumbers'];?></td>
	<td><?php echo $student['Staffdetail']['emailaddresses'];?></td>
	<td><?php echo $student['Staffdetail']['currentresidentialvillage'];?></td>
	<td><?php echo $student['Staffdetail']['currentresidentialsubcounty'];?></td>
	<td><?php echo $student['Staffdetail']['currentresidentialcounty'];?></td>	
	<td><?php echo $student['Staffdetail']['sex']; ?></td>
	<td><?php echo $student['Staffdetail']['availabilitystatus']; ?></td>
	<td><?php
		  echo $this->Html->link(
				    'View ',
				     array('action' => 'view', $student['Staffdetail']['id'])
				     );
		  echo $this->Html->link(
				    'Edit ',
				     array('action' => 'edit', $student['Staffdetail']['id'])
				     );
		  echo $this->Form->postLink(
					'Delete ',
					array('action' => 'delete', $student['Staffdetail']['id']),
