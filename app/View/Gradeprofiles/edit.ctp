<h1 class="sectiondefinition1">Edit Grade profile</h1>
    ...
    //echo $this->Form->hidden('Gradeprofile.id');
    echo $this->Form->hidden('Grading.0.id');
    echo $this->Form->hidden('Grading.1.id');
    echo $this->Form->hidden('Grading.2.id');
    echo $this->Form->hidden('Grading.3.id');
    echo $this->Form->hidden('Grading.4.id');
    echo $this->Form->hidden('Grading.5.id');
    echo $this->Form->hidden('Grading.6.id');
    echo $this->Form->hidden('Grading.7.id');
    echo $this->Form->hidden('Grading.8.id');
    echo $this->Form->hidden('Gradeprofileusesetting.id');
    echo $this->Form->hidden('Ordinaryleveldivisionawardsetting.id');
    echo $this->Form->hidden('Ordinaryleveldivisionaward.0.id');
    echo $this->Form->hidden('Ordinaryleveldivisionaward.1.id');
    echo $this->Form->hidden('Ordinaryleveldivisionaward.2.id');
    echo $this->Form->hidden('Ordinaryleveldivisionaward.3.id');
    echo $this->Form->hidden('Advancedlevelpointsaward.0.id');
    echo $this->Form->hidden('Advancedlevelpointsaward.1.id');
    echo $this->Form->hidden('Advancedlevelpointsaward.2.id');
    echo $this->Form->hidden('Advancedlevelpointsaward.3.id');
    echo $this->Form->hidden('Advancedlevelpointsaward.4.id');
    echo $this->Form->hidden('Advancedlevelpointsaward.5.id');
    echo $this->Form->hidden('Advancedlevelpointsaward.6.id');
    echo $this->Form->hidden('Advancedlevelpointsawardsetting.id');
    
    echo $this->Form->input('Gradeprofile.profilename', array('label' => 'Profile Name'));
    ?>
<?php  
?>
</fieldset>
...
<?php
    ...
    echo $this->Form->end('Edit Details');
