...
$cakeDescription = __d('cake_dev', $SCHOOL_NAME);
  ...
  <div id="container">
    <div id="header">
      ...
      <style type="text/css">
        ...
        #drop-nav2 ul li a:hover {
          background: white;
        }

        #drop-nav2 li:hover>ul {
          display: block;
          position: absolute;
          text-decoration: none;
        }

        #drop-nav2 li:hover li {
          background: #D3D3D3;
          float: none;
          text-decoration: none;
          z-index: 1;
        ...
        #drop-nav2 li:hover a {
          background: #D3D3D3;
          text-decoration: none;
        }

        #drop-nav2 li:hover li a:hover {
          background: #D3D3D3;
          text-decoration: none;
        }
	  ...
	  -->
          ...
          <li><a href="#">Students</a>
            <ul>
              ...
              <li>
                <?php echo $this->Html->link(
                  'Add O-level',
                  array('controller' => 'students', 'action' => "add_olevel")
                ); ?>
              </li>
              <li>
                <?php echo $this->Html->link(
                  'Add A-level',
                  array('controller' => 'students', 'action' => "add_alevel")
                ); ?>
              </li>
            </ul>
          </li>
              ...
              <li><a href="#">View O-level</a>
                <ul>
                  <li>
                    <?php echo $this->Html->link(
                      'Single Student',
                      array('controller' => 'olevelmarksheetresults', 'action' => "viewOlevelResults")
                    ); ?>
                  </li>
                  <li>
              ...
              <li>
                ...
                <ul>
                  <li>
                    <?php echo $this->Html->link(
                      'O-level',
                      array('controller' => 'olevelmarksheetresults', 'action' => "entermarks")
                    ); ?>
                  </li>
                  <li>
                    <?php echo $this->Html->link(
                      'A-level',
                      array('controller' => 'alevelmarksheetresults', 'action' => "entermarks")
                    ); ?>
                  </li>
                </ul>
              </li>
              <li>
                ...
                <ul>
                  <li>
                    <?php echo $this->Html->link(
                      'O-level',
                      array('controller' => 'olevelmarksheetresults', 'action' => "upLoadData")
                    ); ?>
                  </li>
                  <li>
                    <?php echo $this->Html->link(
                      'A-level',
                      array('controller' => 'alevelmarksheetresults', 'action' => "upLoadData")
                    ); ?>
                  </li>
                </ul>
              </li>
          ...
          <li><a href="#">Reports</a>
            <ul>
              <li>
                <?php echo $this->Html->link(
                      'O-level',
                      array('controller' => 'Olevelreportdetails', 'action' => "/")
                    ); 
                ?>
              </li>
              <li>
                <?php echo $this->Html->link(
                      'A-level',
                      array('controller' => 'Alevelreportdetails', 'action' => "/")
                    ); 
                ?>
              </li>
              <!--
          ...
          <li><a href="#">Settings</a>
            <ul>
              <li>
                <?php echo $this->Html->link(
                      'Reports',
                      array('controller' => 'reportsettings', 'action' => "edit", "unique")
                    ); 
                ?>
              </li>
              <li>
                <?php echo $this->Html->link(
                      'Streams',
                      array('controller' => 'schoolstreams', 'action' => "/")
                    ); 
                ?>
              </li>
              <li>
                <?php echo $this->Html->link(
                      'O-level Subjects',
                      array('controller' => 'schooldonesubjects')
                    ); 
                ?>
                <ul>
                  <li>
                    <?php echo $this->Html->link(
                      'Compulsory Subjects',
                      array('controller' => 'Olevelcompulsorysubjects', 'action' => '/')
                    ); 
                    ?>
                  </li>
                </ul>
              ...
              <li>
                  <?php echo $this->Html->link(
                      'A-level Subjects',
                      array('controller' => 'schooldoneasubjects', 'action' => '/')
                    ); 
                  ?>
              </li>
              <li>
                  <?php echo $this->Html->link(
                      'Examinations',
                      array('controller' => 'schooldoneexams', 'action' => '/')
                    ); 
                  ?>
              </li>
              <li>
                <?php echo $this->Html->link(
                      'Grading',
                      array('controller' => 'gradeprofiles', 'action' => '/')
                    ); 
                ?>
                <ul>
                  <li>
                  ...
                  <li>
                    <?php echo $this->Html->link(
                      'Assign profiles',
                      array('controller' => 'gradeprofiles', 'action' => 'assign')
                    ); 
                    ?>
                  </li>
                </ul>
		  ...
		  <li><a href="/daris/departementalheads">HODs</a></li> -->
              <li>
                <?php echo $this->Html->link(
                      'Class Teachers',
                      array('controller' => 'classteachers', 'action' => '/')
                    ); 
                    ?>
              </li>
