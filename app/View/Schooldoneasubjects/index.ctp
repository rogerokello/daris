<?php
  echo $this->Form->create('Schooldoneasubject', array('action' => 'search'));
  if (!isset($searchQuery)) {
    $searchQuery = '';
  }
  echo $this->Form->input('searchQuery', array('label' => 'Search for Subject','value' => h($searchQuery)));
...
<table>
    ...
    <tr>
	<th><?php echo $this->Paginator->sort('fullsubjectname','Full subject name');?></th>
	<th>Short Subject Name</th>
	<th>Subject Code</th>
	<th>Subsidiary?</th>
    ...
    <tr>
	<td><?php echo $student['Schooldoneasubject']['fullsubjectname'];?></td>
	<td><?php echo $student['Schooldoneasubject']['shortsubjectname'];?></td>
	<td><?php echo $student['Schooldoneasubject']['subjectcode'];?></td>
	<td>
	<?php
	    if($student['Schooldoneasubject']['issubsidiary'] == 1){
		echo "YES";
	    }else {
		echo "NO";
	    }
	...
	<?php 
	    if($student['Schooldoneasubject']['papersdone'] != null){
		$papers = explode("$",$student['Schooldoneasubject']['papersdone']);
		...
		$trimmed = ltrim($paper,"Paper");
		$trimmed = trim($trimmed);
		$trimmed = trim($trimmed,",");
		echo "<td>".$trimmed."</td>";
		//echo "<td>".$student['Schooldoneasubject']['papersdone']."</td>";
	    }else {
		echo "<td>"."</td>";
	    }
	...
	<td><?php
		  echo $this->Html->link(
				    'Edit ',
				     array('action' => 'edit', $student['Schooldoneasubject']['id'])
				     );
		  echo $this->Form->postLink(
					'Delete ',
					array('action' => 'delete', $student['Schooldoneasubject']['id'],$student['Schooldoneasubject']['shortsubjectname']),
