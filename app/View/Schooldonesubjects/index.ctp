<?php
  echo $this->Form->create('Schooldonesubject', array('action' => 'search'));
...
<table>
    ...
    <tr>
	<td><?php echo $student['Schooldonesubject']['fullsubjectname'];?></td>
	<td><?php echo $student['Schooldonesubject']['shortsubjectname'];?></td>
	<td><?php echo $student['Schooldonesubject']['subjectcode'];?></td>
	<?php 
	    if($student['Schooldonesubject']['subjectgroup'] != null){
		echo "<td>"."Group ".$student['Schooldonesubject']['subjectgroup']."</td>";
	    }else {
		echo "<td>".$student['Schooldonesubject']['subjectgroup']."</td>";
	    }
	...
	<td><?php
		  echo $this->Html->link(
				    'Edit ',
				     array('action' => 'edit', $student['Schooldonesubject']['id'])
				     );
		  echo $this->Form->postLink(
					'Delete ',
					array('action' => 'delete', $student['Schooldonesubject']['id'],$student['Schooldonesubject']['shortsubjectname']),
