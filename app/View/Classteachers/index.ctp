<!-- <h1 class="sectiondefinition1">Class teachers</h1> -->
<?php
  
  echo $this->Form->create('Classteacher', array('action' => 'search'));
  if (!isset($searchQuery)) {
    $searchQuery = '';
  }
  echo $this->Form->input('searchQuery', array('label' => 'Search class teachers (you may use a name, stream or year)','value' => h($searchQuery)));
...
<table>
    ...
    <tr>
	<td><?php echo $student['Classteacher']['year'];?></td>
	<td><?php echo $student['Classteacher']['title']." ".$student['Classteacher']['names'];?></td>
	<td><?php echo "Senior ".$student['Classteacher']['class'];?></td>
	<td><?php echo $student['Classteacher']['stream'];?></td>
	<td><?php
		  echo $this->Html->link(
				    'Edit ',
				     array('action' => 'edit', $student['Classteacher']['id'])
				     );
		  echo $this->Form->postLink(
					'Delete ',
					array('action' => 'delete', $student['Classteacher']['id']),
