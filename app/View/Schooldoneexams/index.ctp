<?php
  echo $this->Form->create('Schooldoneexam', array('action' => 'search'));
  if (!isset($searchQuery)) {
    $searchQuery = '';
  }
  echo $this->Form->input('searchQuery', array('label' => 'Search for Examination','value' => h($searchQuery)));
...
<table>
	...
	<td><?php
		  echo $this->Html->link(
				    'Edit ',
				     array('action' => 'edit', $student['Schooldoneexam']['id'])
				     );
		  echo $this->Form->postLink(
					'Delete ',
					array('action' => 'delete', $student['Schooldoneexam']['id']/*,$student['Schooldonesubject']['shortsubjectname']*/),
