...
public function alterColumninTable( $previousshortsubjectname,$newshortsubjectname,
				    $subjectpaperstoremove,$subjectpaperstoadd,$subjectpaperstochange
				  ) {
	...
	foreach ($subjectpaperstoadd as $avalue) {	
		...
		$examsconsidered = "_examsconsidered";
		$new2->query("ALTER TABLE alevelreports ADD ".$newshortsubjectname.$avalue.$examsconsidered." VARCHAR(500) CHARACTER SET latin1 COLLATE latin1_swedish_ci NULL;");    
