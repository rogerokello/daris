 ...
 */
	...
	public function report_add_examsconsidered($report_id = null, $subjects = null, $student_ids_on_reports_to_change = null){
		...
		if( $subjects == null ){
		    ...
		    */
		    ...
		    $class_examdone = $Olevelreportdetail->field('reportclass',
			array('id =' => $report_id)
		    );
		    
		    $compulsory_subjects = $Olevelcompulsorysubject->field('compulsorysubjects',
		    ...
		    */
			...
			foreach ( $shortsubjectnames as $shortsubjectname ){
			    ...
			    //count how exams are to be considered
			    $number_of_exams_considered = count($exams_considered_array);
			    
			    // if the number of subjects considered is one, operate using 
